...
<div class="wrapper">
	...
	<div class="ann" style="text-align:center;line-height: 40px;color:#f00;background: #FFF;">推荐使用Chrome，safari，Firefox火狐浏览器浏览器，获得最佳使用体验。</div>
	<!-- Main Content -->
